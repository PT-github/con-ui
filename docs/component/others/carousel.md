...
<template>
  ...
  <div class="block">
    ...
    <s-carousel trigger="click" height="150px">
      <s-carousel-item v-for="item in 4" :key="item">
        <h3 class="small">{{ item }}</h3>
      </s-carousel-item>
    </s-carousel>
...
```html
<template>
  <s-carousel indicator-position="outside">
    <s-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </s-carousel-item>
  </s-carousel>
...
```html
<template>
  <s-carousel :interval="5000" arrow="always">
    <s-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </s-carousel-item>
  </s-carousel>
...
```html
<template>
  <s-carousel :interval="4000" type="card" height="200px">
...
```html
<template>
  <s-carousel height="200px" direction="vertical" :autoplay="false">
    <s-carousel-item v-for="item in 3" :key="item">
      <h3 class="medium">{{ item }}</h3>
    </s-carousel-item>
  </s-carousel>
</template>
