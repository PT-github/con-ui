...
<template>
  ...
  <s-button v-popover:popover>focus 激活</s-button>
  ...
  <s-popover
    ...
    content="这是一段内容,这是一段内容,这是一段内容,这是一段内容。"
    v-model="visible">
    <s-button slot="reference" @click="visible = !visible">手动激活</s-button>
  </s-popover>
</template>
...
<s-popover
  ...
  <div style="text-align: right; margin: 0">
    <s-button size="mini" type="text" @click="visible = false">取消</s-button>
    <s-button type="primary" size="mini" @click="visible = false">确定</s-button>
  </div>
  <s-button slot="reference">删除</s-button>
</s-popover>
