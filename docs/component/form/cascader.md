...
<div class="block">
  ...
  <s-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></s-cascader>
</div>
<div class="block">
...
:::demo
```html
<s-cascader :options="options" clearable></s-cascader>
...
```html
<s-cascader :options="options" :show-all-levels="false"></s-cascader>
...
```html
<s-cascader :props="props"></s-cascader>
...
```html
<s-cascader-panel :options="options"></s-cascader-panel>
