...
<s-progress :percentage="50" status="exception"></s-progress>
...
```html
<s-progress :text-inside="true" :stroke-width="26" :percentage="70"></s-progress>
<s-progress :text-inside="true" :stroke-width="24" :percentage="100" status="success"></s-progress>
<s-progress :text-inside="true" :stroke-width="22" :percentage="80" status="warning"></s-progress>
<s-progress :text-inside="true" :stroke-width="20" :percentage="50" status="exception"></s-progress>
```
:::
...
```html
<s-progress :percentage="percentage" :color="customColor"></s-progress>

<s-progress :percentage="percentage" :color="customColorMethod"></s-progress>
...
<s-progress type="dashboard" :percentage="percentage" :color="colors"></s-progress>
<div>
  <s-button-group>
